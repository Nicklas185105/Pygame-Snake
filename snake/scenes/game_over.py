...
# from snake.scenes.main_menu import MainMenuScene


class GameOverScene(Scene):
    def __init__(self, screen: pygame.Surface):
        super().__init__("GameOverScene", screen)
        self.style = Style(background_color=(50, 50, 50), border_color=(255, 255, 255), text_color=(255, 255, 255))

        # restart_button = UIButton(200, 150, 200, 50, "Restart", lambda: SceneManager.load_scene(MainMenuScene(screen)), self.style)
